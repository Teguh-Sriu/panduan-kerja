...
if [ -z "$cekrbl" ]; then
    ...
    echo "Mantap, IP $IPSERVER aman dari RBL $BL" >> /tmp/cek-rbl1.txt
...
DARI="from:report@idn-lts.com";
TUJUAN="to:teguh@idn-lts.com";
SALINAN="cc:ict@idn-lts.com";
SUBJECT="Subject: IP Public Terblacklist pada RBL"
BODY="
Hi Team,

Selamat, Server di bawah ini melaporkan :
...
-- ICT TEAM PT. LUCKY TEXTILE SEMARANG --
"
